...
c
      ...
      include 'src/Inc/ewinput.f'
      data ewscheme  / 0                  /   ! Chooses EW scheme
...
c---    for Mw=80.385 GeV
      data wwidth/2.085_dp/
      ! data zwidth /2.4952_dp/ ! SM Z boson width
      data zwidth /240.17_dp/ ! width of a Z' with mass = 10 TeV, g_{Z'} = g_Y
...
************************************************************************
*     CKM matrix entries (PDF 2018)                                    *
************************************************************************
      real(dp):: Vud,Vus,Vub,Vcd,Vcs,Vcb
      common/cabib/Vud,Vus,Vub,Vcd,Vcs,Vcb
      data  Vud  ,  Vus  ,  Vub  ,
     &      Vcd  ,  Vcs  ,  Vcb
     &   /0.97446_dp,0.22452_dp,0.00365_dp,
     &    0.22438_dp,0.97359_dp,0.04214_dp/
!      data  Vud  ,  Vus  ,  Vub  ,
!     &      Vcd  ,  Vcs  ,  Vcb
