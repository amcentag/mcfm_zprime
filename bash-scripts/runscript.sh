...
for i in {0..58}
do
    sed "12s/.*/    rundir = $b-s20-pdf${i}-0" input_Z.ini > myinput-$b-${i}-0
    ...
    sed "12s/.*/    rundir = $b-s20-pdf${i}-1" input_Z.ini > myinput-$b-${i}-1
    ...
    sed "12s/.*/    rundir = $b-s20-pdf${i}-2" input_Z.ini > myinput-$b-${i}-2
    ...
    sed "12s/.*/    rundir = $b-s20-pdf${i}-3" input_Z.ini > myinput-$b-${i}-3
